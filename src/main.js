...
axios.interceptors.request.use(
  function(config) {
    ...
    config.headers['access_token'] =
      'eyJhbGciOiJIUzI1NiIsImlhdCI6MTUzOTUyNDAwMCwiZXhwIjoxNzY4NDg0MDAwfQ.eyJpZCI6IjViYzM0NDVmZWRlMjRjNzI4MTQyOWE4OCIsImlhdCI6MTUzOTUyNDAwMC4yMjcyOTQ3fQ.XcZCe_Cyl6qxlvkTyDIFc0TuPI2yXvnfn9dh1ObtmoA'
